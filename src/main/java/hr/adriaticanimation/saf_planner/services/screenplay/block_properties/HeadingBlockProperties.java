...
public class HeadingBlockProperties extends BlockProperties {

    private final PDType1Font font = new PDType1Font(Standard14Fonts.FontName.COURIER_BOLD);

    @Override
    public float getMarginLeft() {
        return ScreenplayConstants.MARGIN_LEFT;
    }
